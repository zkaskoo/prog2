public class HaziFeladat1 {
        ...
        static String donuts(int n) {
            if (n >= 10) {
                ...
                return String.format("Fánkok száma: %d", n);
            }
        }
        ...
        static String bothEnds(String s) {
            ...
            if (hossz < 2) {
                ...
                return s.substring(0, 2) + s.substring(hossz - 2);
            }
        }
        ...
        static String fixStart(String s) {
            ...
            String replaced = s.substring(1).replace(firstChar, '*');
